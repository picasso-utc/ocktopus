...
class TransactionController extends Controller
{
	...
	if($price > 2.40) {
		$basePrice = 2.41;
        	...
        	if ($id < $baseId || $id > 23844 + 19) {  // Si le prix est inférieur à 0.60 ou spérieur à 2.40
	        ...
	        return $id;
                ...
                if ($id < $baseId || $id > 23658 + 200) {  // Si le prix est inférieur à 0.60 ou spérieur à 2.40
                    return 23778; // Prix inconnu ? -> 1e80
                }
    ...
    private function updateMarket($articleId, $quantity)
    {
        ...
        $balanceMarket = 1.70;   // Le marché se balance autour de cette valeur
