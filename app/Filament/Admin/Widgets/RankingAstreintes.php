...
class RankingAstreintes extends BaseWidget
{
    ...
    private function noteIcon($record, string $type): string
    {
        ...
        if ($averageNote >= 2.5) return 'heroicon-o-star';
        else if ($averageNote > 1.5) return 'heroicon-o-face-smile';
        else if ($averageNote > 0.5) return 'heroicon-o-face-frown';
    ...
    private function noteColor($record, string $type): string
    {
        ...
        if ($averageNote >= 2.5) return 'warning';
        else if ($averageNote > 1.5) return 'success';
        else if ($averageNote > 0.5) return 'warning';
        else return 'danger';
    }
